    ...
    <div className="glass-card rounded-xl p-4 flex flex-col gap-3 hover:border-gold/20 transition-colors">
      ...
      <div className="flex flex-wrap items-center gap-1">
        ...
        {prevDiff !== null && prevDiff !== 0 && (
          <span className={`inline-flex items-center px-1.5 py-0.5 rounded text-[11px] font-semibold border ${prevDiff > 0 ? "text-positive bg-positive/10 border-positive/20" : "text-negative bg-negative/10 border-negative/20"}`}>
      ...
      {!predictOpen ? (
        ...
        <div className="p-3 rounded-lg bg-primary/5 border border-primary/15 space-y-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => setPredictOpen(false)} className="text-[11px] text-muted-foreground hover:text-foreground transition-colors">
              Cancelar
            </button>
          </div>
        </div>
