/**
 * Navbar — top bar + mega-menu + quick-strip + menu mobile do JLB.
 * Extraído de components/Layout.tsx (que ficou só como raiz). Inclui os
 * subcomponentes coesos da navegação: ThemeToggle, UserMenu, AlertBell, MegaMenu.
 */
